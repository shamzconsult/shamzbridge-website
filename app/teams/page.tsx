...
import { Mail, Briefcase, Award, ChevronRight, Github, Linkedin, ExternalLink, Sparkles } from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto px-6 pt-40 pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {teamMembers.map((member) => (
            <div
              key={member.id}
              className="group bg-white rounded-3xl p-8 luxury-shadow border border-black/5 hover:border-orange-200 transition-all duration-300 flex flex-col h-full"
            >
              ...
              <div className="pt-6 border-t border-black/5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Linkedin className="w-3.5 h-3.5 text-black/20 hover:text-orange-600 cursor-pointer transition-colors" />
                    <ExternalLink className="w-3.5 h-3.5 text-black/20 hover:text-orange-600 cursor-pointer transition-colors" />
                  </div>
                </div>
              </div>
            </div>
...
// import { teamMembers, managingDirector } from "@/lib/utils"
...
//   return (
//     <div className="min-h-screen relative mt-32">
...
//             className="bg-white/5 backdrop-blur-sm border border-gray-300 rounded-3xl overflow-hidden hover:border-gray-300 transition-all shadow-lg shadow-gray-200/80 min-w-md mx-auto"
//           >
...
//                   width={100}
//                   height={100}
//                   className="rounded-full w-[100%] h-72"
//                 />
//               </div>
//               <div>
...
//                 className="bg-white/5 backdrop-blur-sm border border-gray-200 rounded-2xl overflow-hidden hover:border-gray-300 hover:shadow-xl transition-all shadow-md shadow-gray-200/80"
//               >
//                 <div className="p-8">
...
//                   <a
//                     href={"mailto:" + member.email}
//                     className="flex items-center justify-center gap-2 transition-colors text-sm font-semibold"
//                   >
//                     <Mail className="h-4 w-4" />
//                     Contact
//                   </a>
