...
export default function Footer() {
  ...
  return (
    <footer
      className="min-h-[50vh] bg-cover bg-center bg-no-repeat text-white relative"
      style={{
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-center">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 opacity-90">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="">shamzbridgeconsult@gmail.com</span>
                </div>
                <div className="flex items-center space-x-2">
                  <FaPhone className="h-4 w-4" />
                  <span className="">+234 813 5153 620</span>
                </div>
                <div className="flex items-center space-x-2">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-2">
                ...
                />
                <button className="bg-orange-500 hover:bg-orange-600 px-3 rounded-md">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-x-4 mt-4  md:mt-10">
            <h1>Follow us on :</h1>
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0 opacity-90">
              <li className="ml-4">
                <a
                  target="_blank"
